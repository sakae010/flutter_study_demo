...
class RefreshDemoPage3 extends StatefulWidget {
  const RefreshDemoPage3({Key? key}) : super(key: key);

  @override
  State<RefreshDemoPage3> createState() => _RefreshDemoPage3State();
}

class _RefreshDemoPage3State extends State<RefreshDemoPage3> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("RefreshDemoPage3")),
